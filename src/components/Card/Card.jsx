...
export default function Card({ productInfo }) {
  ...
  return (
    <div className="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 xl:col-span-2 bg-gray-200/55  rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow duration-300">
      {/* Image area */}
      ...
      <div className="p-4 pb-1">
        <h2 className="text-sm font-semibold text-gray-800 line-clamp-1 leading-snug mb-2">
          {title}
        </h2>
        ...
        <div className="flex items-center mb-3 justify-between">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full  bg-gray-900 text-white flex items-center justify-center hover:bg-yellow-700 transition-colors duration-200 hover:scale-110  transform"
          >
